...
//				grantedAuthorities.add(PmdbGrantedAuthority.ROLE_ADMIN);
//				grantedAuthorities.add(PmdbGrantedAuthority.ROLE_USER);
//				User user = new User("admin", "password", grantedAuthorities);
